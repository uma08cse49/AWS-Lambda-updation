...
# ZIPNAME = 'C:/Users/Sandeza/Desktop/serviceNow/index.zip'
ZIPNAME = 'C:/Users/Sandeza/Desktop/serviceNow/index1.zip'
# ZIPNAME = os.path.dirname(os.path.abspath(__file__))+'/files/index.zip'
...
def lambda_updation():
    ...
    try:
        ...
        print("lambda updated successfully.....",response)
